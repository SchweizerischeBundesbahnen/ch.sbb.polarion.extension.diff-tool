...
//
// The article directory defaults to the shipped webapp html (src/main/resources/webapp/diff-tool-app/html,
...
const indexDir = process.env.DOCS_SECTION_INDEX_DIR
  ...
  : resolve(repoRoot, 'src/main/resources/webapp/diff-tool-app/html');
 ...
 * terms further down a section. All articles together are some 10 KB of text.
 */
