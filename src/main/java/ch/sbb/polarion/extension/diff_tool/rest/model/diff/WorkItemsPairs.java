...
public class WorkItemsPairs {
    ...
    @Schema(description = "A collection of WorkItem IDs from left project which contain more than 1 counterpart WorkItem from right project and certain link role", implementation = String.class)
