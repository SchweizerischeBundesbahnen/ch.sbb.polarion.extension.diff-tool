 ...
 * is not used and intentionally throws.
 */
public final class ProjectDuplicationJobUnitFactory implements IJobUnitFactory {
    ...
    private static final ProjectDuplicationJobUnitFactory INSTANCE = new ProjectDuplicationJobUnitFactory();

    public static ProjectDuplicationJobUnitFactory getInstance() {
        return INSTANCE;
    }

    private ProjectDuplicationJobUnitFactory() {
    }
