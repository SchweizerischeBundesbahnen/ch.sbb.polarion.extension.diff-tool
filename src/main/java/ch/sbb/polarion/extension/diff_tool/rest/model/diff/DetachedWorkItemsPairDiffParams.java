...
public class DetachedWorkItemsPairDiffParams {
    ...
    @Schema(description = "Left WorkItem used in the comparison", implementation = WorkItem.class)
    private WorkItem leftWorkItem;

    @Schema(description = "Right WorkItem used in the comparison", implementation = WorkItem.class)
