 ...
 * <p>
 * markdown2html writes all five of them into the app webapp's {@code html/} directory, the one
 ...
 * <ul>
 *   <li>{@code about.html} is read from the classpath by generic's {@code /readme} endpoint, which answers with an
 *       empty body when the article is absent;</li>
 *   <li>the four documentation-site articles are no REST resource at all: the app fetches each as the static file
...
class GeneratedHelpArticlesTest {
    ...
    private void assertArticleGenerated(String fileName) {
        String resource = "/webapp/diff-tool-app/html/" + fileName;
    ...
    @Test
    void velocityApiArticleIsGeneratedIntoTheAppWebapp() {
        assertArticleGenerated("velocity-api.html");
    }
